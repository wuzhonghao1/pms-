        ...
        return (
            <div>
                ...
                <List>
                    ...
                    <Item wrap={true} extra={this.state.data ? this.state.data.PAYMENT_NUM : null}>编号</Item>
                    ...
                    <Item wrap={true} extra={this.state.data ? this.state.data.CONTRACT_CODE : null}>采购合同编号</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.CURRENCY : null}>付款币种</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.PAYMENT_TYPE : null}>付款方式</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.PAY_AMOUNT : null}>付款金额</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.RECEIVED_AMOUNT : null}>已经支付比例</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.EVIDENCE_AMOUNT : null}>项目收款比例</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.VENDOR_NAME : null}>供应商名称</Item>
                </List>
