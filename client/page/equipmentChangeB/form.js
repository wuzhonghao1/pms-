        ...
        return (
            <div>
                ...
                <List>
                    ...
                    <Item wrap={true} align={"top"} extra={this.state.data ? this.state.data.ITEM_NAME : null}>更改/补订原因</Item>
                    <Item wrap={true} align={"top"} extra={this.state.data ? this.state.data.REQUISITION_REASONS : null}>采购申请理由</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.CHANGES_ACOUNT : null}>更改/补订金额</Item>
                    <Item wrap={true} extra={this.state.data ? (this.state.data.BEFORE_MARGIN.toString().replace("%", "") + "%") : null}>原项目第三方设备利润率</Item>
                    <Item wrap={true} extra={this.state.data ? (this.state.data.AFTER_MARGIN.toString().replace("%", "") + "%") : null}>更改/补订后项目第三方设备利润率</Item>
                </List>
