        ...
        return (
            <div>
                ...
                <List>
                    ...
                    <Item wrap={true} extra={this.state.data ? this.state.data.COSTCENTER_NAME : null}>申请部门</Item>
                    <Item wrap={true} align={"top"} extra={this.state.data ? this.state.data.SALE_CONTRACT_NAME : null}>项目名称</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.PUR_CONTRACT_CODE : null}>采购合同编号</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.GUARANTEE_MONEY : null}>亚信开出保函金额</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.FINAL_CUSTOMER : null}>受益人</Item>

                    <Item wrap={true} extra={this.state.data ? this.state.data.SHENMA_INCLUSION_DATE : null}>神码开出保函日期</Item>
                    <Item wrap={true} extra={this.state.data ? this.state.data.SUPPLY_GUARANTEE_CODE : null}>供应商保函号</Item>
                </List>
